            ...
            >
              ...
              <div className="flex justify-evenly items-center">
                <button
                  ...
                  className={`${
                    watchedStatus[anime.mal_id] ? "text-primary" : "text-gen"
                  } hover:text-primary mr-5 text-2xl`}
                >
                  <FontAwesomeIcon icon={faEye} />
                </button>
                <button
                  aria-label="delete"
                  onClick={() => removeBookmarkAnime(anime.mal_id)}
                  className="text-gen hover:text-cool text-2xl"
                >
